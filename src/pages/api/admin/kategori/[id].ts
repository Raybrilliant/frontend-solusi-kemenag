...
// Proxy: GET /api/v1/categories/:id
export const GET: APIRoute = async ({ params, cookies }) => {
  try {
    const res = await fetch(`${BACKEND_URL}/api/v1/categories/${params.id}`, {
...
// Proxy: PUT /api/v1/categories/:id
...
// Proxy: PATCH /api/v1/categories/:id (partial update)
...
// Proxy: DELETE /api/v1/categories/:id
