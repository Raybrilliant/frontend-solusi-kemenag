        ...
        <div class="modal-box">
            ...
            <div class="flex-1 overflow-y-auto min-h-0">
                ...
                {#if step === 1}
                    ...
                    {:else if grouped.length === 0}
                        <div
                            class="flex flex-col items-center justify-center py-16 text-gray-400 text-sm gap-2"
                        >
                            <Icon
                                icon="mdi:magnify"
                                width="32"
                    ...
                    {:else}
                        <div class="px-4 pb-4 space-y-3">
                            {#each grouped as [cat, items]}
                                <div>
                                    <p
                                        class="text-[10px] font-extrabold uppercase tracking-widest text-gray-400 py-2"
                                    >
                                        {cat}
                                    </p>
                                    <div class="space-y-1">
                                        {#each items as l}
                                            ...
                                            >
                                                <div
                                                    class="w-8 h-8 bg-green/10 flex items-center justify-center shrink-0 group-hover:bg-green/20 transition"
                                                >
                                                    <Icon
                                                ...
                                                <Icon
                                                    ...
                                                    width="14"
                                                    height="14"
                                                    class="text-gray-300 group-hover:text-green shrink-0 transition"
                                                />
                                            </button>
                                        {/each}
                                    </div>
                ...
                {:else if step === 2}
                    <div class="p-6 space-y-4">
                        <div
                            class="flex items-center gap-3 bg-green/5 border border-green/20 px-4 py-3"
                        >
                            <div
                            ...
                            <div class="min-w-0 flex-1">
                                <p
                                    class="text-[10px] text-green font-bold uppercase tracking-wide"
                                >
                                    Layanan Dipilih
                                </p>
                            ...
                            <button
                                onclick={backToStep1}
                                class="text-xs text-green font-semibold hover:underline shrink-0"
                                >Ganti</button
                            >
                        </div>
                ...
                {:else}
                    ...
                    >
                        <div
                            class="w-14 h-14 bg-green flex items-center justify-center"
                        >
                            <Icon
                                icon="mdi:check"
                                width="28"
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">
                                Berikan nomor tiket berikut kepada pemohon
                            </p>
                        </div>

                        <div
                            class="w-full bg-green/5 border-2 border-green/30 px-6 py-5"
                        >
                            <p
                                class="text-[10px] font-bold uppercase tracking-widest text-green/60 mb-1"
                            >
                                Nomor Tiket
                            </p>
                            <p
                                class="text-2xl font-black tracking-widest font-mono"
                            >
                                {resultKode}
                            </p>
                        </div>
            ...
            {#if step === 2}
                <div class="border-t px-6 py-4 flex gap-3 shrink-0">
                    <button
                        onclick={backToStep1}
                        class="flex-1 border text-sm font-semibold py-2.5 hover:bg-gray-50 transition"
                    >
                        ← Kembali
                    </button>
                    <button
