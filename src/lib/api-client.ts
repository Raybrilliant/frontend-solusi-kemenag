...
export async function login(nip: string, password: string) {
  return request<{
    ...
    message?: string;
  }>("/api/v1/auth/login", { method: "POST", body: { nip, password } });
}
...
export async function createCategory(data: {
  ...
  return request<{
    ...
    data?: Record<string, unknown>;
    message?: string;
  }>("/api/v1/categories/", { method: "POST", body: data });
}
...
export async function updateCategory(
  ...
  return request<{
    ...
    data?: Record<string, unknown>;
    message?: string;
  }>(`/api/v1/categories/${id}`, { method: "PUT", body: data });
}
...
export async function createLayanan(data: Record<string, unknown>) {
  return request<{
    ...
    data?: Record<string, unknown>;
    message?: string;
  }>("/api/v1/layanan/", { method: "POST", body: data });
}
...
export async function updateLayanan(id: number, data: Record<string, unknown>) {
  return request<{
    ...
    data?: Record<string, unknown>;
    message?: string;
  }>(`/api/v1/layanan/${id}`, { method: "PUT", body: data });
}
...
export async function createPermohonan(data: Record<string, unknown>) {
  return request<{
    ...
    data?: Record<string, unknown>;
    message?: string;
  }>("/api/v1/permohonan/", { method: "POST", body: data });
}
...
export async function updatePermohonanStatus(
  ...
  data: {
    ...
    outputFile?: { nama: string; url: string };
  },
) {
  return request<{
    success: boolean;
    data?: Record<string, unknown>;
    message?: string;
  }>(`/api/v1/permohonan/${id}/status`, { method: "PUT", body: data });
}
